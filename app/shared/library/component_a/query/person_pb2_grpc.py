...
from shared.library.component_a.query import person_pb2 as component__a_dot_query_dot_person__pb2
...
class PersonControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_stream(
                '/component_a.query.PersonController/List',
        ...
        self.Retrieve = channel.unary_unary(
                '/component_a.query.PersonController/Retrieve',
...
def add_PersonControllerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'component_a.query.PersonController', rpc_method_handlers)
...
class PersonController(object):
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/component_a.query.PersonController/List',
    ...
    def Retrieve(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/component_a.query.PersonController/Retrieve',
